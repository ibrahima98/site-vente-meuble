...
<body>
    <header>
        <p class="logo"><img src="./../public/imgS/monLogo (1).jfif"></p>
        <ul class="link">
            <li><a href="./homepage.php">Accueil</a></li>
            <li><a href="./boutique.php">Boutique</a></li>
            <li><a href="#foot">Contact</a></li>
            <li><a href="http://localhost/projet-php-e-com/site-vente-immobilier/src/view/cart.php" class="cart">Panier
                    <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cart-arrow-down" class="svg-inline--fa fa-cart-arrow-down fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512">
